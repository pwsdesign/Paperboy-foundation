        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="lede mt-6 max-w-2xl text-[15px] md:text-[17px] leading-relaxed">
              Paperboy Foundation is a nonprofit print project built to fight
              digital burnout and rebuild local connection through{" "}
              <span className="em-italic">physical objects</span> people keep.
              Not news. Not social. <span className="em-fun">Printed matter</span>{" "}
              with shelf life.
            </p>
          ...
          <aside className="zine-card p-6 md:p-7 md:w-[420px]">
            ...
            <p className="mt-5 text-[12px] text-[rgba(14,15,18,0.55)]">
              Publication stance: no ads, no algorithmic distribution, no chasing
              outrage. Just intentional publishing.
            </p>
          </aside>
        </div>
      </section>
      ...
      <section className="mt-12 grid gap-6 md:grid-cols-2">
        <div className="rulebox p-7 md:p-10">
          ...
          <ul className="mt-6 grid gap-3 text-[15px] leading-relaxed">
            <li>
              <span className="em-shout">Feature</span> local artists, makers,
              musicians, and small businesses.
            </li>
            <li>
              <span className="em-shout">Design</span> each issue like a
              collectible object.
            </li>
            <li>
              <span className="em-shout">Distribute</span> through community
              pickup spots and supporters.
            </li>
            <li>
              <span className="em-shout">Collaborate</span> fairly and
              transparently with creatives.
            </li>
          </ul>
        ...
        <div className="grid gap-6 md:grid-cols-[1.2fr_.8fr] md:items-center">
          <div>
            ...
            <p className="lede mt-4 text-[15px]">
              Your support keeps Paperboy ad-free, community-rooted, and designed
              to be kept.
            </p>
