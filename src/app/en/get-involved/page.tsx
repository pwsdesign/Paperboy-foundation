...
const WAYS = [
  {
    ...
    tag: "Distribution",
    copy:
      "Coffee shops, studios, record stores, galleries. We place small stacks with care.",
    cta: { href: "/en/contact", label: "Become a pickup spot" },
  },
  {
    title: "Submit a story",
    tag: "Features",
    copy:
      "Artists, makers, small businesses, cultural moments. We tell it with taste and restraint.",
    cta: { href: "/en/contact", label: "Pitch a story" },
  },
  {
    title: "Volunteer a hand",
    tag: "Street team",
    copy:
      "Help with drops, photos, outreach, and neighborhood connections.",
    cta: { href: "/en/contact", label: "Join the street team" },
  },
  {
    title: "Partner with us",
    tag: "Collabs",
    copy:
      "If your mission aligns with community, culture, and slow media, let’s build.",
    cta: { href: "/en/contact", label: "Start a partnership" },
  },
];

export default function GetInvolvedEN() {
  return (
      ...
      <section className="rulebox p-7 md:p-12 grain relative">
        ...
        <div className="max-w-3xl">
          ...
          <p className="lede mt-5 text-[15px] md:text-[17px] leading-relaxed">
            Paperboy is community-rooted. We publish small, distribute intentionally,
            and keep it human. Here’s how to plug in.
          </p>

          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            <Link className="btn-ink" href="/en/contact">
              Say hello
            </Link>
            <Link className="btn-outline" href="/en/support">
