...
import { STORIES_EN } from "@/lib/stories.en";
...
export default function StoriesPage() {
  const lang = "en";
  const issues = unique(STORIES_EN.map((s) => s.issue));
    ...
    <main className="wrap py-16 md:py-24">
      <section className="rulebox p-7 md:p-12">
        ...
        <h1 className="headline text-5xl md:text-7xl">
          <span className="glowworm-mn">Stories</span>, unfolded.
        </h1>
        ...
        {STORIES_EN.map((s) => (
          ...
          >
            ...
            <div className="mt-5 flex items-center justify-between">
              <span className="kicker">{s.minutes ? `${s.minutes} min read` : "Read"}</span>
