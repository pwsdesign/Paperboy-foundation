        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="lede mt-5 max-w-2xl text-[15px] md:text-[17px] leading-relaxed">
              ...
              keep. Not news. Not social. <span className="em-fun">Printed matter</span> with shelf life.
            </p>
          </div>
        ...
        <div className="grid gap-7 md:grid-cols-[1.15fr_.85fr] md:items-start">
          <div className="zine-card p-7 md:p-12">
            ...
            <p className="lede mt-5 text-[15px] md:text-[16px]">
              Paperboy is designed like a <span className="em-fun">record</span> or a{" "}
              <span className="em-italic">zine</span> — something you keep, revisit, and share offline.
              The first issue is self-funded. Long-term, the project sustains through community support,
              limited editions, and grants.
            </p>
            ...
            <div className="mt-10 grid gap-5 md:grid-cols-2">
              ...
              <div className="rulebox p-6">
                ...
                <div className="mt-5 flex gap-3">
                  <Link href={`/${lang}/support`} className="btn-ink">Support</Link>
                  <Link href={`/${lang}/contact`} className="btn-outline">Contact</Link>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 border-t pt-7" style={{ borderColor: "var(--rule)" }}>
              ...
              <p className="lede mt-4 text-[15px]">
                Paperboy is intentionally small-scale: <span className="em-italic">fewer issues</span>,{" "}
                <span className="em-fun">better work</span>, longer shelf life. Publishing as an act of care.
              </p>
            </div>
          </div>
